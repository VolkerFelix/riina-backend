...
/// Create mention notifications for users mentioned in a post
///
/// # Arguments
/// * `pool` - Database connection pool
/// * `actor_id` - User ID of the person who created the post (mentioner)
/// * `post_id` - ID of the post containing the mentions
/// * `usernames` - List of usernames that were mentioned
///
/// # Returns
