...
echo "fly secrets set REDIS__REDIS__HOST=evolveme-redis-dev.internal --app evolveme-backend-dev"
echo "fly secrets set REDIS__REDIS__PORT=6379 --app evolveme-backend-dev"
echo "fly secrets set REDIS__REDIS__PASSWORD=$REDIS_PASSWORD --app evolveme-backend-dev"
echo ""
